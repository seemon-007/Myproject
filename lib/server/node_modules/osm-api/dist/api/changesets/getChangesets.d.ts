 ...
 */
export declare function listChangesets(options: ListChangesetOptions): Promise<Changeset[]>;
/** get a single changeset */
export declare function getChangeset(id: number, includeDiscussion?: boolean): Promise<Changeset>;
